           ...
           <div className="owl-carousel team_carousel owl-loaded owl-drag">
             <div className="owl-stage-outer">
               <div
                 className="owl-stage"
                 style={{
                   transform: 'translate3d(-1420px, 0px, 0px)',
                   transition: '0.25s',
                   width: '3195px'
                 }}
               >
                 <div className="owl-item cloned" style={{ width: '340px', marginRight: '15px' }}>
                   <div className="item">
                     <div className="box">
                 ...
                 <div className="owl-item" style={{ width: '340px', marginRight: '15px' }}>
                   <div className="item">
                     <div className="box">
                       <div className="img-box">
                         <img src="images/team1.jpg" alt="" />
                 ...
                 <div className="owl-item active" style={{ width: '340px', marginRight: '15px' }}>
                   <div className="item">
                     <div className="box">
                       <div className="img-box">
                         <img src="images/team2.jpg" alt="" />
                 ...
                 <div className="owl-item cloned active" style={{ width: '340px', marginRight: '15px' }}>
                   <div className="item">
                     <div className="box">
                       <div className="img-box">
                         <img src="images/team1.jpg" alt="" />
